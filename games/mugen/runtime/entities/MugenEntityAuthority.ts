...
export class MugenEntityAuthority {
  ...
  readonly #actionResetHelpers = new Set<string>();
  #tick = 0;
  #open = false;
  #nextPlayerId = 1;
  ...
  beginTick(tick: number): this {
    ...
    this.#tick = tick; this.#open = true; this.#commandCount = 0; this.#diagnostics.length = 0; this.#positionFrozenHelpers.clear(); this.#actionResetHelpers.clear(); return this;
  }
  ...
  advance(paused = false, superPaused = false): this {
    ...
    for (const entity of this.#orderedEntities()) {
      if (entity.kind !== 'root' && entity.createdTick === this.#tick) continue;
    ...
    this.#positionFrozenHelpers.clear(); this.#actionResetHelpers.clear();
    return this;
  }
