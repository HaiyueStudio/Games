...
export const PURCHASE_COPY = {
  ...
  de: {"title": "Vollversion freischalten", "owned": "Vollversion freigeschaltet", "features": "Einmalkauf · Unbegrenzte Hinweise, alle Tage, werbefrei", "free": "Tagespuzzle kostenlos. Erfolge bleiben erhalten", "buy": "Kaufen", "restore": "Käufe wiederherstellen", "retry": "Neu verbinden", "today": "Heute spielen", "close": "Zurück", "loading": "Verbindung zum Store…", "ready": "Preis vom Store · Kein Abo", "purchasing": "Bestätige den Kauf im Store…", "restoring": "Käufe werden wiederhergestellt…", "pending": "Zahlung ausstehend. Nicht erneut kaufen", "cancelled": "Abgebrochen. Dein Puzzle bleibt erhalten", "offline": "Offline. Verbinde dich und versuche es erneut", "unavailable": "Produkt nicht verfügbar. Später versuchen", "error": "Kaufprüfung fehlgeschlagen. Erneut versuchen", "revoked": "Kauf widerrufen. Bezahlfunktionen gesperrt", "restored": "Kauf wiederhergestellt", "empty": "Keine Käufe für dieses Store-Konto gefunden"},
  es: {"title": "Desbloquear juego completo", "owned": "Juego completo desbloqueado", "features": "Compra única · Pistas ilimitadas, todas las fechas, sin anuncios", "free": "Puzle diario gratis. Tu historial se conserva", "buy": "Comprar", "restore": "Restaurar compras", "retry": "Reconectar", "today": "Jugar hoy", "close": "Volver", "loading": "Conectando con la tienda…", "ready": "Precio de la tienda · Sin suscripción", "purchasing": "Confirma la compra en la tienda…", "restoring": "Restaurando compras…", "pending": "Pago pendiente. No vuelvas a comprar", "cancelled": "Cancelado. Tu puzle se conserva", "offline": "Sin conexión. Conéctate e inténtalo de nuevo", "unavailable": "Producto no disponible. Inténtalo más tarde", "error": "No se pudo verificar la compra. Reintenta", "revoked": "Compra revocada. Funciones de pago bloqueadas", "restored": "Compra restaurada", "empty": "No hay compras para restaurar en esta cuenta"},

  zh: { title: '解锁完整版', owned: '完整版已解锁', features: '一次购买 · 无限提示、任意日期、无广告', free: '每天的当日拼图免费，通关记录始终保留', buy: '购买', restore: '恢复购买', retry: '重新连接', today: '玩今天', close: '返回',
  ...
  en: { title: 'Unlock full game', owned: 'Full game unlocked', features: 'One purchase · Unlimited hints, any date, no ads', free: "Today's puzzle is free. Your history stays saved", buy: 'Buy', restore: 'Restore purchases', retry: 'Reconnect', today: 'Play today', close: 'Back',
  ...
  ja: { title: '完全版を購入', owned: '完全版は購入済みです', features: '一度の購入 · ヒント無制限・全日付・広告なし', free: '当日のパズルは無料。クリア記録は保持されます', buy: '購入', restore: '購入を復元', retry: '再接続', today: '今日をプレイ', close: '戻る',
