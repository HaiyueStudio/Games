...
test('G08 Petra extended AI trace reaches special, helper, effect and audio paths deterministically', { skip: !existsSync(join(directory, entryDef)), timeout: 90_000 }, async () => {
  ...
  assert(visited.some(value => value >= 1_000 && value < 5_000), `Petra AI never entered a special state; visited ${visited.join(',')}`);
