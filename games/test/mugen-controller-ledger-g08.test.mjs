...
test('G08 generated controller ledger exactly closes the frozen official 89-item census', () => {
  const census = readMugenTestArtifact('m08-mugen-asset-vertical-slice/g01-contract/feature-census.json');
  const ledger = readMugenTestArtifact('m09-mugen-character-runtime-parity/official-controller-ledger.json');
...
test('G08 generated parameter ledger covers every documented MUGEN 1.1b1 controller parameter accepted by strict import', () => {
  const featureCensus = readMugenTestArtifact('m08-mugen-asset-vertical-slice/g01-contract/feature-census.json');
  const controllerLedger = readMugenTestArtifact('m09-mugen-character-runtime-parity/official-controller-ledger.json');
  const parameterLedger = readMugenTestArtifact('m09-mugen-character-runtime-parity/controller-parameter-ledger.json');
