...
import {
  cloneSudokuBoard as cloneBoard,
  emptySudokuBoard as emptyBoard,
  generateSudokuPuzzle as generatePuzzle,
  isSudokuSaveData,
  isSudokuValueAllowed as isAllowed,
  setSudokuBoardValue as setBoardValue,
  SUDOKU_BOX_SIZE as BOX,
  SUDOKU_SIZE as SIZE,
  sudokuBoardValue as boardValue,
...
export async function startSudoku(canvas: HTMLCanvasElement): Promise<void> {
